...
@section('content')
    ...
    <form method="POST" enctype="multipart/form-data" action="{{route('user.list.update',['list_id' => $list[0]->list_id])}}">
        <form>
            @csrf
        ...
        <a class="maintaining" href ="{{route('user.lists')}}">Back to maintaining</a>
@endsection
