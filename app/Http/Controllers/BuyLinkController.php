...
class BuyLinkController extends  Controller
{
    ...
    public function show($id)
    {
        ...
        return view('user.buyLinks.show')->with('buy_links',$buy_link);
    }

    public function create()
    {
        $books = Book::all();
        return view('user.buyLinks.create')->with('books',$books);
    }
    ...
    {
        $buy_link = $this->_buyLinkRepository->findById($id);
        return view('user.buyLinks.edit')->with('buy_link',$buy_link);
    }
